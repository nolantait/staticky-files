...
RSpec.describe Staticky::Files do
  ...
  describe "#chmod" do
    ...
    it "raises an argument error when the permissions are given in non-numeric format" do
      ...
      expect { subject.chmod(path, "+x") }
        .to raise_error Staticky::Files::Error, "mode should be an integer (e.g. 0o755)"
    end
  ...
  describe "#delete_directory" do
    ...
    it "raises error if directory doesn't exist" do
      ...
      expect { subject.delete_directory(path) }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#unshift" do
    ...
    it "raises error if path doesn't exist" do
      ...
      expect { subject.unshift(path, "# frozen_string_literal: true") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#replace_first_line" do
    ...
    it "raises error if target cannot be found in path" do
      ...
      expect { subject.replace_first_line(path, "not existing target", "  def self.call(input)") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::MissingTargetError)
    ...
    it "raises error if path doesn't exist" do
      ...
      expect { subject.replace_first_line(path, "perform", "  def self.call(input)") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#replace_last_line" do
    ...
    it "raises error if target cannot be found in path" do
      ...
      expect { subject.replace_last_line(path, "not existing target", "  def self.call(input)") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::MissingTargetError)
          expect(exception.message).to eq("cannot find `not existing target' in `#{path}'")
        end
    ...
    it "raises error if path doesn't exist" do
      ...
      expect { subject.replace_last_line(path, "perform", "  def self.call(input)") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#inject_line_before" do
    ...
    it "raises error if target cannot be found in path" do
      ...
      expect { subject.inject_line_before(path, "not existing target", "  # It performs the operation") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::MissingTargetError)
          expect(exception.message).to eq("cannot find `not existing target' in `#{path}'")
        end
    ...
    it "raises error if path doesn't exist" do
      ...
      expect { subject.inject_line_before(path, "call", "  # It performs the operation") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#inject_line_before_last" do
    ...
    it "raises error if target cannot be found in path" do
      ...
      expect { subject.inject_line_before_last(path, "not existing target", "  # It performs the operation") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::MissingTargetError)
          expect(exception.message).to eq("cannot find `not existing target' in `#{path}'")
        end
    ...
    it "raises error if path doesn't exist" do
      ...
      expect { subject.inject_line_before_last(path, "call", "  # It performs the operation") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#inject_line_after" do
    ...
    it "raises error if target cannot be found in path" do
      ...
      expect { subject.inject_line_after(path, "not existing target", "    :result") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::MissingTargetError)
          expect(exception.message).to eq("cannot find `not existing target' in `#{path}'")
        end
    ...
    it "raises error if path doesn't exist" do
      ...
      expect { subject.inject_line_after(path, "call", "    :result") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#inject_line_after_last" do
    ...
    it "raises error if target cannot be found in path" do
      ...
      expect { subject.inject_line_after_last(path, "not existing target", "    :result") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::MissingTargetError)
          expect(exception.message).to eq("cannot find `not existing target' in `#{path}'")
        end
    ...
    it "raises error if path doesn't exist" do
      ...
      expect { subject.inject_line_after_last(path, "call", "    :result") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#remove_line" do
    ...
    it "raises error if target cannot be found in path" do
      ...
      expect { subject.remove_line(path, "not existing target") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::MissingTargetError)
          expect(exception.message).to eq("cannot find `not existing target' in `#{path}'")
        end
    ...
    it "raises error if path doesn't exist" do
      ...
      expect { subject.remove_line(path, "frozen") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#inject_line_at_block_top" do
    ...
    it "raises error if file cannot be found" do
      ...
      expect { subject.inject_line_at_block_top(path, "configure", "") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#inject_line_at_block_bottom" do
    ...
    it "raises error if file cannot be found" do
      ...
      expect { subject.inject_line_at_block_bottom(path, "configure", "") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
  ...
  describe "#remove_block" do
    ...
    it "raises an error when the file was not found" do
      ...
      expect { subject.remove_block(path, "configure") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::IOError)
          expect(exception.cause).to be_a(Errno::ENOENT)
          expect(exception.message).to include(path.to_s)
    ...
    it "raises error if block cannot be found" do
      ...
      expect { subject.remove_block(path, "not existing target") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::MissingTargetError)
          expect(exception.message).to eq("cannot find `not existing target' in `#{path}'")
        end
