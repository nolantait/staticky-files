...
require "staticky/files/memory_file_system/node"
require "English"

RSpec.describe Staticky::Files::MemoryFileSystem::Node do
  ...
  describe "#unset" do
    ...
    it "removes child" do
      ...
      expect(subject.get(segment)).to be_nil
    end

    it "raises error if trying to remove unexisting child" do
      expect { subject.unset("foo") }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::UnknownMemoryNodeError)
  ...
  describe "#read" do
    ...
    it "raises error when not file" do
      expect { subject.read }
        .to raise_error do |exception|
          expect(exception).to be_a(Staticky::Files::NotMemoryFileError)
